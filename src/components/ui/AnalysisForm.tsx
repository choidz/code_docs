        ...
        <>
                    ...
                    <FormField label="분석 옵션">
                        <div className="ai-toggle-container">
                            <div className="toggle-switch">
                                <input id="block-toggle" type="checkbox" checked={props.shouldExtractBlocks} onChange={(e) => props.setShouldExtractBlocks(e.target.checked)} />
            ...
            <FormField label="📂 소스 위치 선택">
                <div className="radio-group">
                    ...
                    <label>
                        <input type="radio" value="upload" checked={props.sourceMethod === 'upload'} onChange={(e) => props.setSourceMethod(e.target.value as any)} />
                        파일/ZIP 업로드
                    </label>
                    <label>
                        <input type="radio" value="folder" checked={props.sourceMethod === 'folder'} onChange={(e) => props.setSourceMethod(e.target.value as any)}
            ...
            {props.sourceMethod === 'upload' && (
                <FormField label="파일/ZIP 업로드">
                    ...
                    <input type="file" onChange={props.onFileChange} className="file-input" id="file-upload-input" style={{ display: 'none' }} />
    ...
    <div className="preset-actions">
      ...
      <button onClick={props.onSavePreset} className="preset-btn save">
        저장
            ...
            {/* {props.sourceMethod !== 'upload' && ( */}
            <button onClick={props.onRunAnalysis} className="add-button" disabled={props.isLoading} style={{ width: '100%' }}>
